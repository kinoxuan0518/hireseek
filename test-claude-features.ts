...
async function testClaudeFeatures() {
  ...
  console.log(chalk.gray('  seeya                 # 对话模式'));
  console.log(chalk.gray('  seeya run --plan      # 计划模式'));
  console.log(chalk.gray('  seeya tasks           # 任务看板'));
  console.log(chalk.gray('  seeya dashboard       # 实时控制台\n'));
