...
function buildPlist(): string {
  ...
  const envKeys = [
    ...
    'FEISHU_HIRE_ENABLED', 'FEISHU_HIRE_AUTO_APPLY',
    'FEISHU_HIRE_PASS_VALUES', 'FEISHU_HIRE_FAIL_VALUES',
    'FEISHU_BITABLE_NAME_FIELD', 'FEISHU_BITABLE_RESULT_FIELD',
    'FEISHU_BITABLE_PASS_VALUES', 'FEISHU_BITABLE_FAIL_VALUES',
