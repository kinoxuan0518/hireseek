on run argv
	...
	tell application "Google Chrome"
		...
		-- Click on candidate by name
		set js1 to "(function(){var items=document.querySelectorAll('.geek-item');for(var i=0;i<items.length;i++){var t=items[i].innerText;if(t.indexOf('" & targetName & "')!=-1){items[i].click();return 'clicked';}}return 'not_found';})()"
